#!/bin/bash
mkdir "$3/AppIcons"
mkdir "$3/AppIcons/Android"
mkdir "$3/AppIcons/Android/GooglePlay"
mkdir "$3/AppIcons/Android/drawable-mdpi"
mkdir "$3/AppIcons/Android/drawable-hdpi"
mkdir "$3/AppIcons/Android/drawable-xhdpi"
mkdir "$3/AppIcons/Android/drawable-xxhdpi"
mkdir "$3/AppIcons/Android/drawable-xxxhdpi"
mkdir "$3/AppIcons/iOS"
